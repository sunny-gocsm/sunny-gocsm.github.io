...
const TopPerformingAccounts = ({ accounts }: TopPerformingAccountsProps) => {
  const navigate = useNavigate();

  return (
    <div className="rounded-2xl bg-card border border-border/40 shadow-card p-6">
      <h3 className="text-sm font-semibold text-card-foreground mb-4 tracking-tight">Top Performing Accounts</h3>
              ...
              <tr key={acc.id} className="border-b border-border/30 last:border-0 hover:bg-secondary/40 transition-colors">
                ...
                <td className="py-3.5 text-center">
                  <div className="flex items-center justify-center gap-1">
                    ...
                    <span className={cn("text-xs font-medium", acc.trend >= 0 ? "text-health-green" : "text-health-red")}>
...
export default TopPerformingAccounts;
